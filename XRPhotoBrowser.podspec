...
Pod::Spec.new do |spec|
  ...
  #   功能强大，内存占用低，高效流畅且支持图片转场效果的照片浏览框架。
  ...
  spec.author             = { "violetbuddhist" => "violet_buddhist@163.com" }
  # Or just: spec.author    = "violetbuddhist"
  # spec.authors            = { "violetbuddhist" => "violet_buddhist@163.com" }
  # spec.social_media_url   = "https://twitter.com/violetbuddhist"
  ...
  spec.source       = { :git => "http://EXAMPLE/XRPhotoBrowser.git", :tag => "#{spec.version}" }
